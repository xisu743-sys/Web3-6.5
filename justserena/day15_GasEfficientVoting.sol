...
contract GasEfficientVoting {
    ...
    function createProposal(bytes32 name, uint32 duration) external {
        ...
        uint8 proposalId = proposalCount;//是第几个提案就编号为几
        proposalCount++;
        ...
        proposals[proposalId] = newProposal;//把新的提案放到对应编号的格子里
    ...
    function vote(uint8 proposalId) external {
        ...
        uint256 mask = 1 << proposalId;//制作对应的提案编号遮罩板
        require((voterData & mask) == 0, "Already voted");
        
        // Record vote using bitwise OR
        voterRegistry[msg.sender] = voterData | mask;//把mask对应的开关拨到1
