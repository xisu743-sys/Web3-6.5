...
contract YieldFarming is ReentrancyGuard {
    ...
    IERC20 public stakingToken;// 存入的种子
    IERC20 public rewardToken;// 长出的果实
    ...
    struct StakerInfo {
        uint256 stakedAmount;// 存了多少
        uint256 rewardDebt;// 已经攒了多少果实还没领
        uint256 lastUpdate;// 上次浇水（更新）是什么时候
    }
